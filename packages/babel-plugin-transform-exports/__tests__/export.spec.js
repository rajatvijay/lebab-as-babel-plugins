import transformExports from '../src/index';
...
describe('Export CommonJS', () => {
  describe('default export', () => {
    // TODO: Remove the expression instead of declaration hack
  ...
  describe('named export', () => {
    ...
    // TODO: See if we should be covering this in this specific plugin
